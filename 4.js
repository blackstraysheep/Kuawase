...
window.addEventListener("message", (event) => {
    console.log("[4.js] message received", event.data);
...
if (window.electron) {
    console.log("[4.js] window.electron is available, setting up IPC listener.");

    window.electron.receive("update-content", (data) => {
        console.log("[4.js] Received data via IPC:", data);
    ...
    console.warn("[4.js] window.electron is undefined. Skipping IPC listener setup.");
}
...
if (gameid) {
    ...
    console.error("[4.js] 'gameid' element not found.");
}
